...
% Alexander Nechyporenko - 20021759
...
%Mdl = fitrsvm(inputdata, label,'KernelFunction','rbf','KernelScale','auto');
% linear and polynomial are terrible
...
%title('SVM MAE ILI from ILI');
%title('SVM Hum from Hum');
...
% csvwrite('prediction_rsvm_transformation.csv', prediction);
...
%t = templateTree('NumVariablesToSample','all','PredictorSelection','curvature');
